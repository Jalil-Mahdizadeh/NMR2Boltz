...
- `benchmark.yaml`: checksum-pinned, target-aware 6M6O benchmark case.
...
`output/coordinate_comparison/summary.json`. The conversion-regression summary
is `output/benchmark/benchmark_summary.json`.
